  ...
  import { sendMessage } from "@/lib/api/messageService"
...
const [formData, setFormData] = useState<{
  ...
  phone: string
  subject: string
  program?: string   // <-- burada opsiyonel
  message: string
  newsletter: boolean
}>({
  firstName: "",
  ...
  phone: "",
  subject: "",
  program: undefined,   // <-- başlangıçta undefined
  message: "",
  newsletter: false,
})
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!payload.program) {
        delete payload.program   // boşsa API’ye hiç gönderme
      }
      console.log("POST PAYLOAD:", payload) // debug için
